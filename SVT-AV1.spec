...
Source0  : https://gitlab.com/AOMediaCodec/SVT-AV1/-/archive/v1.4.1/SVT-AV1-v1.4.1.tar.gz
...
%prep
%setup -q -n SVT-AV1-v1.4.1
cd %{_builddir}/SVT-AV1-v1.4.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671044338
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libSvtAv1Enc.so.1.4.1
