...
Version  : 2.1.0
Release  : 28
URL      : https://gitlab.com/AOMediaCodec/SVT-AV1/-/archive/v2.1.0/SVT-AV1-v2.1.0.tar.gz
Source0  : https://gitlab.com/AOMediaCodec/SVT-AV1/-/archive/v2.1.0/SVT-AV1-v2.1.0.tar.gz
...
%prep
%setup -q -n SVT-AV1-v2.1.0
cd %{_builddir}/SVT-AV1-v2.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716094976
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libSvtAv1Enc.so.2.1.0
