...
Source0  : https://gitlab.com/AOMediaCodec/SVT-AV1/-/archive/v1.0.0/SVT-AV1-v1.0.0.tar.gz
...
%prep
%setup -q -n SVT-AV1-v1.0.0
cd %{_builddir}/SVT-AV1-v1.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650641713
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/SVT-AV1-v1.0.0/LICENSE-BSD2.md %{buildroot}/usr/share/package-licenses/SVT-AV1/3a6355145854d7b1eab7a96b586b49b1f3925041
cp %{_builddir}/SVT-AV1-v1.0.0/LICENSE.md %{buildroot}/usr/share/package-licenses/SVT-AV1/46e7694aaf9130a640379739ddc0b972f98a7230
cp %{_builddir}/SVT-AV1-v1.0.0/third_party/cpuinfo/LICENSE %{buildroot}/usr/share/package-licenses/SVT-AV1/3e10e8cc50f6524daf4c62cc0daae3ccd187da3e
cp %{_builddir}/SVT-AV1-v1.0.0/third_party/cpuinfo/deps/clog/LICENSE %{buildroot}/usr/share/package-licenses/SVT-AV1/aef1ae9e4471bbac8a19a56ae105e87602ab02bc
cp %{_builddir}/SVT-AV1-v1.0.0/third_party/fastfeat/LICENSE %{buildroot}/usr/share/package-licenses/SVT-AV1/7cbe19df00ff13a33eb7638354c37c4f7382f94f
cp %{_builddir}/SVT-AV1-v1.0.0/third_party/googletest/LICENSE %{buildroot}/usr/share/package-licenses/SVT-AV1/5a2314153eadadc69258a9429104cd11804ea304
cp %{_builddir}/SVT-AV1-v1.0.0/third_party/safestringlib/LICENSE %{buildroot}/usr/share/package-licenses/SVT-AV1/4902cae9d3ebedcfbd51da29a80c5eba5c7e308a
pushd clr-build
%make_install
popd
...
/usr/lib64/libSvtAv1Enc.so.1.0.0
