...
Source0  : https://gitlab.com/AOMediaCodec/SVT-AV1/-/archive/v2.1.2/SVT-AV1-v2.1.2.tar.gz
...
%prep
%setup -q -n SVT-AV1-v2.1.2
cd %{_builddir}/SVT-AV1-v2.1.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719949804
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libSvtAv1Enc.so.2.1.2
