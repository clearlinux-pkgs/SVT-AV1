...
%prep
%setup -q -n SVT-AV1-v0.9.0
cd %{_builddir}/SVT-AV1-v0.9.0
...
cp %{_builddir}/SVT-AV1-v0.9.0/third_party/googletest/LICENSE %{buildroot}/usr/share/package-licenses/SVT-AV1/5a2314153eadadc69258a9429104cd11804ea304
cp %{_builddir}/SVT-AV1-v0.9.0/third_party/safestringlib/LICENSE %{buildroot}/usr/share/package-licenses/SVT-AV1/4902cae9d3ebedcfbd51da29a80c5eba5c7e308a
pushd clr-build
%make_install
popd
...
/usr/lib64/libSvtAv1Enc.so.0.9.0
