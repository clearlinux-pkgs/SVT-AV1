...
Source0  : https://gitlab.com/AOMediaCodec/SVT-AV1/-/archive/v2.2.0/SVT-AV1-v2.2.0.tar.gz
...
%prep
%setup -q -n SVT-AV1-v2.2.0
cd %{_builddir}/SVT-AV1-v2.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724165565
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libSvtAv1Enc.so.2.2.0
