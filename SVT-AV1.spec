...
Version  : 2.1.1
Release  : 29
URL      : https://gitlab.com/AOMediaCodec/SVT-AV1/-/archive/v2.1.1/SVT-AV1-v2.1.1.tar.gz
Source0  : https://gitlab.com/AOMediaCodec/SVT-AV1/-/archive/v2.1.1/SVT-AV1-v2.1.1.tar.gz
...
%prep
%setup -q -n SVT-AV1-v2.1.1
cd %{_builddir}/SVT-AV1-v2.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719350423
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libSvtAv1Enc.so.2.1.1
