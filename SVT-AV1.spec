...
Version  : 2.0.0
Release  : 27
URL      : https://gitlab.com/AOMediaCodec/SVT-AV1/-/archive/v2.0.0/SVT-AV1-v2.0.0.tar.gz
Source0  : https://gitlab.com/AOMediaCodec/SVT-AV1/-/archive/v2.0.0/SVT-AV1-v2.0.0.tar.gz
...
%prep
%setup -q -n SVT-AV1-v2.0.0
cd %{_builddir}/SVT-AV1-v2.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710616048
mkdir -p clr-build
pushd clr-build
