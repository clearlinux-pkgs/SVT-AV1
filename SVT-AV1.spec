...
Source0  : https://gitlab.com/AOMediaCodec/SVT-AV1/-/archive/v1.8.0/SVT-AV1-v1.8.0.tar.gz
...
%prep
%setup -q -n SVT-AV1-v1.8.0
cd %{_builddir}/SVT-AV1-v1.8.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707106032
mkdir -p clr-build
pushd clr-build
