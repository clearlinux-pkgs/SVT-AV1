...
Source0  : https://gitlab.com/AOMediaCodec/SVT-AV1/-/archive/v1.3.0/SVT-AV1-v1.3.0.tar.gz
...
%prep
%setup -q -n SVT-AV1-v1.3.0
cd %{_builddir}/SVT-AV1-v1.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666229216
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libSvtAv1Enc.so.1.3.0
